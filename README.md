...
### System
  - [0xAX / linux-insides](https://github.com/0xAX/linux-insides) | [(한국어 버전)](https://github.com/junsooo/linux-insides-ko)
    - 리눅스 커널과 그 내부 구조에 대한 정리 (The goal is simple)
  - [kaist-cp / cs420](https://github.com/kaist-cp/cs420)
    - KAIST 컴파일러 설계 강의

### Machine Learning (AI)
  - [heartcored98 / Standalone-DeepLearning](https://github.com/heartcored98/Standalone-DeepLearning)
    - 2019 KAIST 딥러닝 홀로서기 세미나
  - [awesome-davian / awesome-reviews-kaist](https://github.com/awesome-davian/awesome-reviews-kaist)
...
### Program Language
  - [yagom-academy / swift-doc-kor](https://github.com/yagom-academy/swift-doc-kor)
    - Swift API Design Guide 문서 번역본 (야곰 아카데미 작성)
  - [EbookFoundation / free-programming-books](https://github.com/EbookFoundation/free-programming-books) | [(한국어 버전)](https://github.com/EbookFoundation/free-programming-books/blob/main/books/free-programming-books-ko.md)
    - 무료 프로그래밍 도서 모음
  - [kamranahmedse / developer-roadmap](https://github.com/kamranahmedse/developer-roadmap)
    - 개발자 로드맵
  - [keyuls / Free-Programming-Tutorials](https://github.com/keyuls/Free-Programming-Tutorials)
    - 무료 프로그래밍 튜토리얼 모음
  - [fullstackreact / react-daily-ui](https://github.com/fullstackreact/react-daily-ui)
    - React UI

### Algorithm / Coding Test
  - [TheAlgorithms](https://github.com/TheAlgorithms)
    - 자료구조와 알고리즘 구현의 오픈소스
  - [CodeTest-StudyGroup / Code-Test-Study](https://github.com/CodeTest-StudyGroup/Code-Test-Study)
    - 코딩테스트 기출 문제 풀이와 설명

### MIscellaneous
  - [alex / what-happens-when](https://github.com/alex/what-happens-when) | [(한국어 버전)](https://github.com/SantonyChoi/what-happens-when-KR)
...
### Application
  ...
  - [subscriptionRescueTeam / save-my-youth](https://github.com/subscriptionRescueTeam/save-my-youth)
    - 청년을 위한 청약 정보 한 눈에 보기 (아직 프로젝트 진행중으로 보임)
  - [joyfuI / NaverCafePass](https://github.com/joyfuI/NaverCafePass)
    - 검색허용이나 멤버공개인 네이버 카페 글을 가입 없이 보게 도와주는 확장 프로그램
  - [TeamSparker / Spark-Server](https://github.com/TeamSparker/Spark-Server)
    - 친구와 함께 하는 66일 습관 형성 서비스
  - [yourtablecloth / TableCloth](https://github.com/yourtablecloth/TableCloth)
...
### Program Analysis
  ...
  - [secure-software-engineering / FlowDroid](https://github.com/secure-software-engineering/FlowDroid)
    - 안드로이드/Java 애플리케이션의 정적 데이터 흐름 분석기(Static Data Flow Analysis Tool)
  - [airbus-seclab / bincat](https://github.com/airbus-seclab/bincat)
  ...
  - [mborgerson / mdec](https://github.com/mborgerson/mdec)
  ...
  - [analysis-tools-dev / dynamic-analysis](https://github.com/analysis-tools-dev/dynamic-analysis)
    - 동적 분석기 모음집
  - [eurecom-s3 / symcc](https://github.com/eurecom-s3/symcc)
    - Efficient Compiler-based Symbolic Execution
  - [therealsaumil / emux](https://github.com/therealsaumil/emux)
  ...
  - [algorithm-visualizer / algorithm-visualizer](https://github.com/algorithm-visualizer/algorithm-visualizer)
    - 반응형 알고리즘 성능 시각화 플랫폼
  - [googleprojectzero / TinyInst](https://github.com/googleprojectzero/TinyInst)
  ...
  - [favocado / Favocado](https://github.com/favocado/Favocado)
    - DOM Fuzzer
  - [vtil-project / VTIL-Core](https://github.com/vtil-project/VTIL-Core)
    - Deobfuscation and Devirtualization을 위한 Virtual-machine Translation
  - [SNSystems / DIVA](https://github.com/SNSystems/DIVA)
...
### Miscellaneous
  ...
  - [tistory-projects / tistory-skin-hELLO](https://github.com/tistory-projects/tistory-skin-hELLO)
    - hELLO 티스토리 스킨
  - [HomoEfficio / dev-tips](https://github.com/HomoEfficio/dev-tips)
    - 개발하다 마주친 작은 문제와 해결 방법 정리
  - [subinium / Misc-Cheatsheet](https://github.com/subinium/Misc-Cheatsheet)
